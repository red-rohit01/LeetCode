...
public:
    vector<vector<int>> validArrangement(vector<vector<int>>& pairs) {
        ...
        // If no such node exists, start from the first pair's first element and It also means that the structure is kind of 
        // Circular. so, any node can be taken as the startNode
